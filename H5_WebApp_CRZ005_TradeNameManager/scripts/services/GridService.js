    ...
    (function (application) {
        var GridService = (function () {
            ...
            GridService.prototype.clearGridStates = function () {
                var _this = this;
                var gridIds = ["sampleGrid1", "ZZUDF8ListGrid", "customerMasterListGrid", "itemGroupListGrid"];
            ...
            GridService.prototype.getZZUDF8ListGrid = function () {
                var ZZUDF8ListGrid = angular.copy(this.baseGrid);
                var gridLinkCellTemplate = "<div class=\"ui-grid-cell-contents\" title=\"TOOLTIP\"><span class=\"h5-link\" ng-click=\"grid.appScope.ZZUDF8Module.loadZZUDF8RecordModule(col.field, row.entity)\">{{COL_FIELD CUSTOM_FILTERS}}</span></div>";
                ZZUDF8ListGrid.columnDefs = [
                    { name: "PK03", displayName: this.languageService.languageConstants.get('Trade name'), cellTemplate: gridLinkCellTemplate, enableCellEdit: false },
                    { name: "AL31", displayName: this.languageService.languageConstants.get('Description'), headerCellClass: "text-left", cellClass: "text-left", enableCellEdit: false },
                    { name: "PK02", displayName: this.languageService.languageConstants.get('Language'), headerCellClass: "text-left", cellClass: "text-left", enableCellEdit: false },
                ];
                ZZUDF8ListGrid.exporterCsvFilename = "sample_list.csv";
                ZZUDF8ListGrid.exporterPdfFilename = "sample_list.pdf";
                ZZUDF8ListGrid.saveSelection = false;
                return ZZUDF8ListGrid;
            };
