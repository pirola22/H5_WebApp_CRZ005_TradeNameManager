module h5.application {
    ...
    export class GridService {
        ...
        public clearGridStates() {
            let gridIds = ["sampleGrid1", "ZZUDF8ListGrid", "customerMasterListGrid", "itemGroupListGrid"]; //added
        ...
        public getZZUDF8ListGrid(): IUIGrid {
            let ZZUDF8ListGrid: IUIGrid = angular.copy(this.baseGrid);
            let gridLinkCellTemplate = "<div class=\"ui-grid-cell-contents\" title=\"TOOLTIP\"><span class=\"h5-link\" ng-click=\"grid.appScope.ZZUDF8Module.loadZZUDF8RecordModule(col.field, row.entity)\">{{COL_FIELD CUSTOM_FILTERS}}</span></div>";
